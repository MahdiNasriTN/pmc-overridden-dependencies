...
class _TreeDraggableState<T extends Object> extends State<TreeDraggable<T>> with AutomaticKeepAliveClientMixin {
  @override
  ...
  void _createAutoScroller([ScrollableState? scrollable]) {
    _autoScroller = EdgeDraggingAutoScroller(scrollable ?? Scrollable.of(context)!, velocityScalar: 20, onScrollViewScrolled: () {
