...
class PlutoGridStateChangeNotifier extends PlutoChangeNotifier
  ...
  PlutoColumnFilterState? columnFilterWidget(PlutoColumn column) {
    final GlobalKey<PlutoColumnFilterState>? filterKey = column.filterKey;
    return filterKey?.currentState;
  }
  ...
  void resetAllFilters() {
    ...
    eventManager?.addEvent(PlutoGridResetAllFiltersEvent());

    notifyListeners();
  }

// Delete all filters
  void deleteAllFilters(PlutoGridStateManager stateManager) {
    refRows
      ..clear()
      ..addAll(rows);
  }
...
class PlutoGridStateManager extends PlutoGridStateChangeNotifier {
  ...
  static List<PlutoRow> initializeRows(List<PlutoColumn> refColumns,
  ...
  static Future<List<PlutoRow>> initializeRowsAsync(List<PlutoColumn> refColumns,
      List<PlutoRow> refRows, {
        bool forceApplySortIdx = true,
        bool increase = true,
        int start = 0,
