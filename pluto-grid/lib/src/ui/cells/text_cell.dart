...
mixin TextCellState<T extends TextCell> on State<T> implements TextFieldProps {
  ...
  void _showCustomMenu(BuildContext context) {
    ...
    _overlayEntry = _createOverlayEntry(context, position, selection);
    Overlay.of(context)?.insert(_overlayEntry!);
  }

  OverlayEntry _createOverlayEntry(BuildContext context, Offset position, TextSelection selection) {
