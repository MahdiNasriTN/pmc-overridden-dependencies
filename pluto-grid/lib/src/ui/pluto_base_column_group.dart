...
class _ColumnGroupTitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final double groupTitleHeight =
        columnGroup.group.hasChildren ? columnGroup.group.height ?? (depth - childrenDepth) * stateManager.columnHeight : depth * stateManager.columnHeight;
          ...
          child: columnGroup.group.hasDropDown!
              ? DropdownButtonHideUnderline(
                  child: DropdownButton2(
                      ...
                      menuItemStyleData: const MenuItemStyleData(padding: EdgeInsets.symmetric(horizontal: 5), height: 40),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              style: columnGroup.group.textStyle != null
                                  ? columnGroup.group.textStyle!.copyWith(color: isHovered ? Colors.white : columnGroup.group.textStyle!.color)
                                  : style.columnTextStyle.copyWith(color: isHovered ? Colors.white : style.columnTextStyle.color),
