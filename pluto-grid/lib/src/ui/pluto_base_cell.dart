  ...
  void _addGestureEvent(PlutoGridGestureType gestureType, Offset offset) {
    stateManager.eventManager!.addEvent(
      PlutoGridCellGestureEvent(
        gestureType: column.type is PlutoColumnTypeNumber || column.type is PlutoColumnTypeText || column.type is PlutoColumnTypeDate || column.type is PlutoColumnTypeCurrency || column.type is PlutoColumnTypeTime
            ? gestureType
...
class _CellContainerState extends PlutoStateWithChange<_CellContainer> {
    ...
    _decoration = update(
      ...
      _boxDecoration(
        ...
        isSelectedCell: stateManager.isSelectedCell(
            ...
            stateManager.currentSelectedCells.contains(PlutoGridSelectingCellPosition(field: widget.column.field, rowIdx: widget.rowIdx)),
  ...
  BoxDecoration _boxDecoration({
    ...
    if (isCurrentCell) {
      ...
      return BoxDecoration(
        color: isGroupedRowCell ? cellColorGroupedRow : (widget.cell.overrideColorCheckbox ?? (widget.cell.withOpacity ? widget.cell.overridedColor : widget.cell.overridedColor?.withOpacity(0.6))),
